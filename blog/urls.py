...
from.views import (IndexPage,ContactPage,AboutUsPage,ArticleDetail,
                   AllArticleApiViews,ArticleCreateView,SingleArticleApiView,
                   SearchArticleAPIView,CreateArticleAPIView,DeleteArticleAPIView,category_page
                   )   
